          ...
          <div className="grid col-span-1 relative">
            ...
            <div className="relative">
              ...
              <span className="absolute top-1/2 right-4 transform -translate-y-1/2 pointer-events-none h-5 w-5 rounded flex items-center justify-center bg-[#313A6C]">
                {/* Use an SVG for the custom arrow */}
                <svg
                  width="10"
                  height="6"
                  viewBox="0 0 10 6"
        ...
        <div className="grid gap-4 lg:gap-[30px] grid-cols-1 md:grid-cols-2">
          <div>
            ...
            <label className="" htmlFor="go-live">
              <div
                className={`col-span-1 pt-4 pr-[19px] pb-6 pl-6 flex gap-5 items-center border rounded ${
                  serverType === "go-live"
                    ? "border-[#147AFF]"
                    : "border-[#313A6C]"
                }`}
                ...
                >
                  ...
                  <div className="flex items-center gap-.5">
                    {singleBlueprint.tags.slice(0, 3).map((blueprintTag) => (
                      <div
                        key={blueprintTag.id}
                        className={`text-[${blueprintTag.textColor}] text-sm bg-[${blueprintTag.bgColor}] py-[7px] px-[5px] border border-[#373E60] rounded h-6 w-6 inline-flex items-center justify-center`}
                      >
