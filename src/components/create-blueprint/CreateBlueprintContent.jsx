...
const CreateBlueprintContent = ({
  ...
  return (
    <div className="bg-[#171A30CC] fixed inset-x-0 inset-y-0 flex flex-col items-center justify-center z-50 ">
      <div ref={modalRef} className="overflow-auto space-y-3.5 py-4">
        {/* modal warning */}
        {isWarningOpen && <ModalWarning setIsWarningOpen={setIsWarningOpen} />}
